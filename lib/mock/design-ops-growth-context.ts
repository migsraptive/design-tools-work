...
export const growthStageOptions: Array<{ value: GrowthStage; label: string }> = [
  { value: "q2_learn", label: "Q2 Learn" },
  { value: "q3_scale", label: "Q3 Scale" },
  { value: "q4_expand", label: "Q4 Expand" },
  { value: "fy2027_optimize", label: "2027 Optimize" },
];

export const objectiveTypeOptions: Array<{ value: ObjectiveType; label: string }> = [
  { value: "product", label: "Product" },
  { value: "go_to_market", label: "Go-To-Market" },
  { value: "segment_strategy", label: "Segment Strategy" },
  { value: "learning_agenda", label: "Learning Agenda" },
];
