          ...
          {referenceTeamResearch.map((entry) => (
            <div key={entry.title} className="space-y-1.5">
              <div className="flex items-center gap-2.5">
                <div className={`size-7 rounded-full flex items-center justify-center text-[10px] font-semibold text-white shrink-0 ${entry.color}`}>
                  {entry.initials}
                </div>
                <div className="flex-1 min-w-0">
        ...
        <CardContent className="space-y-4">
          {referenceCommunityVoices.map((voice) => (
            <div key={voice.name} className="space-y-1.5">
              <div className="flex items-center gap-2.5">
                <div className={`size-7 rounded-full flex items-center justify-center text-[10px] font-semibold text-white shrink-0 ${voice.color}`}>
                  {voice.initials}
                </div>
