...
export function LiveDraftHeaderFields({
  ...
  const fieldToneClassName =
    titleTone === "field"
      ? "!text-lg !leading-tight !font-normal !tracking-normal text-muted-foreground"
      : titleSizeClassName;
  const titleClassName = inline
    ? `!h-auto w-full border-none bg-transparent !px-0 !py-0 ${fieldToneClassName} shadow-none outline-none ring-0 placeholder:text-lg placeholder:text-muted-foreground/35 focus-visible:ring-0 focus-visible:ring-offset-0`
    : undefined;
  const descriptionClassName = inline
    ? "w-full resize-none border-none bg-transparent px-0 text-base text-muted-foreground shadow-none outline-none ring-0 placeholder:text-lg placeholder:text-muted-foreground/35 focus-visible:ring-0 focus-visible:ring-offset-0"
    : undefined;
